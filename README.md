...
To update the database use this command from the Web project folder (replace `OnlineStore` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../OnlineStore.Infrastructure/OnlineStore.Infrastructure.csproj -s OnlineStore.Web.csproj
```
